...
- Detailed aggregation controls for neighbor thresholds, persistent contact hits, bootstrap growth, sticking chance, walker count, launch/kill padding, and growth batch size.
...
- **Attachment Neighborhood / Stick Neighbors:** Selects which nearby cells contribute to attachment and how much occupied-neighbor score is required before sticking.
